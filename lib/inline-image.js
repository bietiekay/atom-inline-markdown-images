...
const imageStyle = `max-width: 85%;`
const strDiv = 'div'
const imageContainerStyle = `text-align: center; padding: 5px;`
...
module.exports = class InlineImage {
  ...
  refresh() {
    ...
    this.editor.scan(REGEX_IMAGES, ({range, match}) => {
      ...
      this.editor.decorateMarker(marker, {type: 'block', item: imageContainer, position: 'after'})
    })
  }
